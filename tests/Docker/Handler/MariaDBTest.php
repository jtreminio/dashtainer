...
use DashtainerBundle\Docker\Handler\MariaDB;
...
class MariaDBTest extends KernelTestCase
{
    ...
    protected function setUp()
    {
        ...
        $handler = $this->getMockBuilder(MariaDB::class)
...
services:
  mariadbservice:
    ...
    labels:
      ...
      - 'traefik.frontend.rule=Host:mariadbservice.localhost'
    volumes:
      - "$PWD/mariadbservice/datadir:/var/lib/mysql:delegated"
      - "~/www:/var/www:cached"
