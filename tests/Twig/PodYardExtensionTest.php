...
namespace PodYardBundle\Tests\Twig;

use PodYardBundle\Twig\PodYardExtension;

use Symfony\Bundle\FrameworkBundle\Test\KernelTestCase;

class PodYardExtensionTest extends KernelTestCase
{
    /** @var PodYardExtension */
    protected $extension;

    protected function setUp()
    {
        $this->extension = new PodYardExtension();
    }
