...
class Deploy implements Util\HydratorInterface
{
    ...
    /**
     * @uses \Dashtainer\Entity\Docker\Service\Deploy\Placement
    ...
    /**
     * @uses \Dashtainer\Entity\Docker\Service\Deploy\Resources
     * @see https://docs.docker.com/compose/compose-file/#resources
     */
    protected $resources = [];

    /**
     * @uses \Dashtainer\Entity\Docker\Service\Deploy\RestartPolicy
