...
class Deploy implements Util\HydratorInterface
{
    ...
    /**
     * @uses \Dashtainer\Entity\DockerService\Deploy\Placement
    ...
    /**
     * @uses \Dashtainer\Entity\DockerService\Deploy\Resources
     * @see https://docs.docker.com/compose/compose-file/#resources
     */
    protected $resources = [];

    /**
     * @uses \Dashtainer\Entity\DockerService\Deploy\RestartPolicy
