...
class MariaDB extends Docker\HandlerAbstract implements Docker\HandlerInterface
{
    protected const SERVICE_TYPE = 'mariadb';
    ...
    {
        $version = $this->pyServiceConfig->getSettings()['version'] ?? 10.2;
